 ...
 * cutcoinjs/daemonRPC
 * 
 * A class for making calls to a Cutcoin daemon's RPC API using Node.js
 ...
 */
class daemonRPC {
  constructor(hostname = '127.0.0.1', port = 24248, user = undefined, pass = undefined, protocol = 'http', network = 'mainnet') {
      ...
      if (typeof hostname == 'object') { // parameters can be passed in as object/dictionary
        ...
        if ('autoconnect' in params) {
          if (params['autoconnect']) { // TODO add mainnet/testnet toggle
            ...
            this.daemons.unshift(...daemonsLocal); // Put common local cutcoind addresses and ports at the front of the list of daemons to try 
  ...
  /**
   * Test a local or remote Cutcoin RPC API for accessibility
   *
   * @function _test
   * @param {string} hostname - RPC hostname
  ...
  /**
   * Execute command on the Cutcoin RPC API
   *
   * @function _run
  ...
  _run(method = null, params = undefined, extension = 'json_rpc') {
    ...
    return axios.post(`${this.protocol}://${this.hostname}:${this.port}/${extension}`, options)
    .then(result => {
   ...
   * Retrieve a block template that can be mined upon
   *
   * @function getposblocktemplate
   * @param {string} wallet_address - Address of wallet to receive coinbase transactions if block is successfully mined
   * @param {int} pos_tx_size - PoS tx size; max 255 bytes.
   * @param {int} timestamp - Timestamp.
   *
   * @returns {promise} resolve, reject
   * @resolves {object} - Example: {
   *   blocktemplate_blob: "",
   *   difficulty: 0,
   *   expected_reward: 1221299828158,
   *   height: 586544,
   *   merkleroot: "f0d785543e8a473b5a43e14495d4920f57aa048c7b136f2f623d45b59040948d",
   *   prev_crypto_hash: "78557a50bc5c663e47b308ccb65b6900e0eed6c1af03fadaaca3861ddafd6774",
   *   prev_hash: "0bf51e483705389e617e9cdf58c0f59ef0109185c36ba5a56ee437c252070000",
   *   status: "OK",
   *   untrusted: false
   * }
   */
  getposblocktemplate(wallet_address, pos_tx_size, timestamp) {
    if (typeof wallet_address == 'undefined') {
      throw new Error('Error: Wallet address required');
    }
    if (typeof pos_tx_size == 'undefined') {
      throw new Error('Error: PoS tx size required');
    }
    if (typeof timestamp == 'undefined') {
      throw new Error('Error: Timestamp required');
    }
    
    let params = {
      wallet_address: wallet_address,
      pos_tx_size: pos_tx_size,
      timestamp: timestamp,
      decode_as_json: true
    };

    return this._run('getposblocktemplate', params);
  }
  
  /**
   * Alias of getblocktemplate
   */
  get_pos_block_template(wallet_address, pos_tx_size, timestamp) {
    return this.getposblocktemplate(wallet_address, pos_tx_size, timestamp);
  }
   ...
   * Submit a mined block to the network
   *
   * @function submitposblock
   * @param {string} block_blob - Block blob data string
   * @param {string} pos_tx_blob - Coinstake tx blob data string
   *
   * @return object - Example: // TODO: example
   */
  submitposblock(block_blob, pos_tx_blob) {
    if (typeof block_blob == 'undefined') {
      throw new Error('Error: Block blob required');
    }
    if (typeof pos_tx_blob == 'undefined') {
      throw new Error('Error: Coinstale tx blob required');
    }
    
    let params = {
      block_blob: block_blob,
      pos_tx_blob: pos_tx_blob,
      decode_as_json: true
    };

    return this._run('submitposblock', params);
  }
  
  /**
   * Alias of submitblock
   */
  submit_pos_block(block_blob, pos_tx_blob) {
    return this.submitposblock(block_blob, pos_tx_blob);
  }
   ...
   * }
   */
  generateblocks(wallet_address, amount_of_blocks = 1, timestamp) {
    if (typeof wallet_address == 'undefined') {
      throw new Error('Error: Wallet address required');
    }
    if (typeof reserve_size == 'undefined') {
  ...
  /**
   * Get the staking status of the daemon.
   *
   ...
   * @resolves {object} - Example: {
      block_mining_info: {
        difficulty: 131952362,
        height: 586557,
        pos_hash: "78497f2be102f5b5630639125e793f86ae0fb97aad9d566f5a224dd874010000",
        timestamp: 1616185631
      },
      status: "OK"
   * }
   */
   getmininginfo() {
    return this._run('getmininginfo');
  }
  
  /**
   * Alias of getmininginfo
   */
  get_mining_info() {
   ...
   *   algorithm: "PoS v 1.0",
   *   block_time: 60,
   *   difficulty: 123452366,
   *   height: 586534,
   *   pos_hash: "<e02f51384a682e6f981b4e6ad9080899ab998e60c8890464117047e5df1d0000>",
   *   status: "OK"
   * }
   */
  staking_status() {
    let params = { decode_as_json: true };
    return this._run(null, params, 'staking_status');
  }
