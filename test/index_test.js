'use strict';
const Cutcoin = require('../index.js');
  ...
  for (let network in daemons) {
    for (let i in daemons[network]) {
      ...
      it(`should connect to ${network} daemon at ${daemon['hostname']}`, done => {
        let daemonRPC = new Cutcoin.daemonRPC(daemon) // Check if remote daemon is available
        .then(daemon => {
...
describe('daemonRPC constructor', () => {
  it('should autoconnect to mainnet daemon', done => {
    var daemonRPC = new Cutcoin.daemonRPC({ autoconnect: true, random: true, network: 'mainnet' })
    .then(daemon => {
      daemon.should.be.a.Object();
  ...
  it('should autoconnect to testnet daemon', done => {
    var daemonRPC = new Cutcoin.daemonRPC({ autoconnect: true, random: true, network: 'testnet' })
    .then(daemon => {
      daemon.should.be.a.Object();
  ...
  it('should autoconnect to stagenet daemon', done => {
    var daemonRPC = new Cutcoin.daemonRPC({ autoconnect: true, random: true, network: 'stagenet' })
    .then(daemon => {
      daemon.should.be.a.Object();
  ...
  it('should connect to daemon', done => {
    var daemonRPC = new Cutcoin.daemonRPC({ autoconnect: true, random: true, network: network })
    .then(daemon => {
      daemon.should.be.a.Object();
      ...
      describe('daemonRPC methods', () => {
        ...
        if (daemonRPC['local']) { // Only run the following tests on a local daemon
          ...
          describe('staking_status()', () => {
            it('should stop mining', done => {
              daemonRPC.staking_status()
              .then(result => {
                result.should.be.a.Object();
                result.status.should.be.a.String();
                result.status.should.be.equal('OK');
...
describe('walletRPC constructor', () => {
  it('should connect to wallet', done => {
    var walletRPC = new Cutcoin.walletRPC({ autoconnect: true, network: network, initialize: false })
    .then(wallet => {
      ...
      describe('walletRPC methods', () => {
        ...
        describe('change_wallet_password()', () => {
          it(`should change wallet password to 'cutcoinjs' and back (to '')`, done => {
            walletRPC.change_wallet_password('', 'cutcoinjs')
            .then(result => {
              result.should.be.a.Object();
        ...
        describe('create_address()', () => {
          it('should create new subaddress', done => {
            walletRPC.create_address(0, 'cutcoinjs unit test suite')
            .then(result => {
              result.should.be.a.Object();
              result.address.should.be.a.String();
                ...
                if (balance <= 0) {
                  ...
                  describe('set_tx_notes()', () => {
                    it('should set note for transfer', done => {
                      walletRPC.set_tx_notes([tx_hash], ['cutcoinjs unit test suite transaction note'])
                      .then(result => {
                        result.should.be.a.Object();
                      })
                      .then(done, done);
                  ...
                  describe('get_tx_notes()', () => {
                    it('should get note for transfer', done => {
                      ...
                      .then(result => {
                        ...
                        result.notes[0].should.be.equal('cutcoinjs unit test suite transaction note');
                      })
                      .then(done, done);
                    });
                  });
                  ...
                  describe('get_transfer_by_txid()', () => {
                    it('should get transfer information', done => {
                      ...
                      .then(result => {
                        ...
                        result.transfer.note.should.be.equal('cutcoinjs unit test suite transaction note');
                      })
                      .then(done, done);
                    });
                  });
        ...
        describe('label_address()', () => {
          it('should set address label', done => {
            walletRPC.label_address({ major: 0, minor: address_index }, 'cutcoinjs unit test suite subaddress label')
            .then(result => {
              result.should.be.a.Object();
            })
            .then(done, done);
        ...
        describe('create_account()', () => {
          it('should create new account', done => {
            walletRPC.create_account('cutcoinjs unit test suite')
            .then(result => {
              result.should.be.a.Object();
              result.address.should.be.a.String();
        ...
        describe('label_account()', () => {
          it('should label wallet account', done => {
            walletRPC.label_account(account_index, 'cutcoinjs unit test suite account label')
            .then(result => {
              result.should.be.a.Object();
            })
            .then(done, done);
        ...
        describe('tag_accounts()', () => {
          it('should tag wallet account', done => {
            walletRPC.tag_accounts([account_index], 'cutcoinjs unit test suite account tag')
            .then(result => {
              result.should.be.a.Object();
            })
            .then(done, done);
        ...
        describe('set_account_tag_description()', () => {
          it('should add a description to the wallet account tag', done => {
            walletRPC.set_account_tag_description('cutcoinjs unit test suite account tag', 'cutcoinjs unit test suite account tag description')
            .then(result => {
              result.should.be.a.Object();
            })
            .then(done, done);
        ...
        describe('set_attribute()', () => {
          it('should set wallet attribute', done => {
            walletRPC.set_attribute('ATTRIBUTE_DESCRIPTION', 'cutcoinjs unit test suite wallet description')
            .then(result => {
              result.should.be.a.Object();
            })
            .then(done, done);
        ...
        describe('get_attribute()', () => {
          it('should get wallet attribute', done => {
            ...
            .then(result => {
              ...
              result.value.should.be.equal('cutcoinjs unit test suite wallet description');
            })
            .then(done, done);
          });
        });
        ...
        describe('sign()', () => {
          it('should sign message', done => {
            walletRPC.sign('cutcoinjs unit test suite message')
            .then(result => {
              result.should.be.a.Object();
              result.signature.should.be.a.String();
        ...
        describe('verify()', () => {
          it('should verify signed message', done => {
            walletRPC.verify('cutcoinjs unit test suite message', address, signature)
            .then(result => {
              result.should.be.a.Object();
              result.good.should.be.a.Boolean();
              result.good.should.be.equal(true);
        ...
        describe('make_uri()', () => {
          it('should make uri', done => {
            walletRPC.make_uri(address, 0.123456789101, '394dc6dfc57071eb897685e27e6017c45c656758fed9a0b01627f0a644547b5b', 'cutcoinjs unit test suite', 'cutcoinjs unit test suite uri')
            .then(result => {
              result.should.be.a.Object();
        ...
        describe('parse_uri()', () => {
          it('should parse uri', done => {
            ...
            .then(result => {
              ...
              result.uri.recipient_name.should.be.equal('cutcoinjs unit test suite');
              result.uri.tx_description.should.be.a.String();
              result.uri.tx_description.should.be.equal('cutcoinjs unit test suite uri');
            })
            .then(done, done);
          });
        });
        ...
        describe('add_address_book()', () => {
          it('should add address to address book', done => {
            walletRPC.add_address_book(address, '394dc6dfc57071eb897685e27e6017c45c656758fed9a0b01627f0a644547b5b', 'cutcoinjs unit test suite address book entry')
            .then(result => {
              result.should.be.a.Object();
        ...
        describe('get_address_book()', () => {
          it('should get address book entry', done => {
            ...
            .then(result => {
              ...
              result.entries[0].description.should.be.equal('cutcoinjs unit test suite address book entry');
